...
### TASK-001: 페이지 골격 및 라우팅 + 더미 데이터 구축 `TODO`
...
### TASK-003: 대시보드 UI 구현 (더미 데이터) `TODO`
...
### TASK-004: 이벤트 생성 Wizard UI `TODO`
...
### TASK-005: 게스트 참여 + 가용성 입력 UI `TODO`
...
### TASK-006: 이벤트 관리 + 히트맵 그리드 컴포넌트 `TODO`
